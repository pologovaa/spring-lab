package factory.injectspringbean;
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(InjectSpringBean.class)) {
                ...
                if (springContext == null) {
                    throw new IllegalStateException("Spring application context must be provided to " + factory.context.ApplicationContext.class +
